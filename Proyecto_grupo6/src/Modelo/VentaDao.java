...
public class VentaDao {
    ...
    public int RegistrarVenta(Facturacion v){
    ...
    public int RegistrarDetalle(Bancos Dv){
    ...
    public List Listarventas(){
       List<Facturacion> ListaVenta = new ArrayList();
       ...
       try {
           ...
           rs = ps.executeQuery();
           while (rs.next()) {               
               Facturacion vent = new Facturacion();
    ...
    public Facturacion BuscarVenta(int id){
        Facturacion cl = new Facturacion();
